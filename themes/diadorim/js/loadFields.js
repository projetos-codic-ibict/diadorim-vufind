...
function addCardsList(records) {
  ...
  records.forEach(record => {
    if (record) {
      ...
      switch (sealSplited[0].trim()) {
        case 'Prata':
          seal += `<div class="svg-circle silver-seal">
        ...
        case 'Azul':
          seal += `<div class="svg-circle blue-seal">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        case 'Amarelo':
          seal += `<div class="svg-circle yellow-seal">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        case 'Verde':
          seal += `<div class="svg-circle green-seal">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
